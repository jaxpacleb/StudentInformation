 ...
 * @author acer
 */
public class InvalidContactNumber extends javax.swing.JDialog {

    /**
     * Creates new form InvalidContactNumber
     */
    public InvalidContactNumber(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        label.setText("<html>Please make sure your contact number<br> is valid and does not exceed 12 characters.\n</html>");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(28, 28, 28)
                .addComponent(okayBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InvalidContactNumber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InvalidContactNumber dialog = new InvalidContactNumber(new javax.swing.JFrame(), true);
